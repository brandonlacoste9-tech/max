...
const ConfidentialitePage = () => (
  <div className="min-h-screen font-body bg-[#0C0A09] text-white gold-edge-lighting">
    ...
    <main className="relative z-10 max-w-3xl mx-auto px-8 py-16">
      <h1 className="text-4xl font-heading font-bold text-[#C9A34F] mb-8">Politique de confidentialité</h1>
      <div className="prose prose-invert prose-lg text-white/80 space-y-6">
        <p>Voyageur Luxury et FloGuru s&apos;engagent à protéger vos données. Nous ne vendons pas vos informations personnelles.</p>
