...
const PageFallback = () => (
  <div className="min-h-screen bg-[#0C0A09] flex items-center justify-center text-[#C9A34F] font-body gold-edge-lighting">
    <div className="animate-pulse">Loading...</div>
  </div>
);

const RouteErrorFallback = () => (
  <div className="min-h-screen bg-[#0C0A09] flex flex-col items-center justify-center p-8 text-center gold-edge-lighting">
